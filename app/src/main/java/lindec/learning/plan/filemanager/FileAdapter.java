...
public class FileAdapter extends BaseAdapter {
    ...
    public FileAdapter(Context context, ArrayList<String> na, ArrayList<String> pa) {
        names = na;
        paths = pa;
        directory = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher);
        file = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher);
        //缩小图片
